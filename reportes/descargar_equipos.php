...
$proveedorFiltro = TableFilter::positiveInt('idproveedor', $_GET);
...
$params = [];
if ($filtro !== '') {
    $conditions[] = '(ma.nombreMarca LIKE ? OR mo.nombreModelo LIKE ? OR eq.codigo_activo LIKE ? OR eq.numero_serie LIKE ? OR eq.tipo_equipo LIKE ? OR p.nombre LIKE ?)';
    $like = "%$filtro%";
...
$columns = [
    ['label' => 'Codigo',    'width' => 22, 'align' => 'C'],
    ['label' => 'Tipo',      'width' => 27, 'align' => 'L'],
    ['label' => 'Serie',     'width' => 32, 'align' => 'L'],
    ['label' => 'Marca',     'width' => 25, 'align' => 'L'],
    ['label' => 'Modelo',    'width' => 35, 'align' => 'L'],
    ['label' => 'Proveedor', 'width' => 35, 'align' => 'L'],
    ['label' => 'Compra',    'width' => 20, 'align' => 'C'],
    ['label' => 'Garantia',  'width' => 20, 'align' => 'C'],
    ['label' => 'Estado',    'width' => 32, 'align' => 'C'],
];
