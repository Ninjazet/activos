...
<script>
$(document).ready(function(){ ajaxLoad('<?= BASE_URL ?>/app/ajax/consultas/asignaciones.php'); });
$(document).on('keyup','#buscar',function(){ ajaxLoadDebounced('<?= BASE_URL ?>/app/ajax/consultas/asignaciones.php',$(this).val()); });
</script>
<div class="wrapper">
