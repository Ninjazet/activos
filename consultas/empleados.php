...
<script>
$(document).ready(function(){ ajaxLoad('<?= BASE_URL ?>/app/ajax/consultas/empleados.php'); });
$(document).on('keyup','#buscar',function(){ ajaxLoadDebounced('<?= BASE_URL ?>/app/ajax/consultas/empleados.php',$(this).val()); });
</script>
<div class="wrapper">
